This file contains a git repo with an excellent header scroll effect, plan you might introduce this into our home screen.
...
{
  "expo": {
    "name": "expo-progressive-blur",
    "slug": "expo-progressive-blur",
    "version": "1.0.0",
    "orientation": "portrait",
    "icon": "./assets/images/icon.png",
    "scheme": "expoprogressiveblur",
